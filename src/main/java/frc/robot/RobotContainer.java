...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    TrajectoryConfig config = new TrajectoryConfig(DriveTrain.maxVelocity, DriveTrain.maxAcceleration);
    Trajectory trajectory = TrajectoryGenerator.generateTrajectory(Arrays.asList(new Pose2d(),
    new Pose2d(0.0, 1.0, new Rotation2d(0))), 
    /*
    ...
    */
    ...
    m_drive.getRightController(), m_drive::setVoltages, m_drive);
